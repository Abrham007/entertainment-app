...
export default function NavBar() {
  return (
    <header className="max-w-full h-[56px] md:h-[72px] lg:w-[96px] lg:h-full lg:max-h-[960px] flex lg:flex-col lg:gap-[75px] justify-between items-center px-4 md:p-6 lg:px-8 lg:py-9 md:mx-[25px] md:my-[23px] lg:m-8 bg-SemiDarkBlue md:rounded-[10px] lg:roudned-[20px]">
      <Image
        src="/images/logo.svg"
